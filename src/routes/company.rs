...
pub fn routes() -> Router<AppState> {
    Router::new()
        .route("/", post(handle_create_company))
        .route("/", get(handle_get_user_companies))
        .route("/{company_id}", get(handle_get_company))
        .route("/{company_id}", put(handle_update_company))
        .route("/{company_id}", delete(handle_delete_company))
        .route(
            "/{company_id}/with-usernames",
            get(handle_get_company_with_usernames),
        )
        .route("/{company_id}/members", post(handle_add_member))
        .route("/{company_id}/members", delete(handle_remove_member))
}
